...
blob_img = pygame.image.load('img/skeleton.png')
...
arrow_sign_img = pygame.image.load('img/arrow_sign.png')
bush_img = pygame.image.load('img/bush_two.png')
tombstone_img = pygame.image.load('img/tombstone_two.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 12:
					...
					screen.blit(img, (col * tile_size, row * tile_size - (tile_size * 3)))
